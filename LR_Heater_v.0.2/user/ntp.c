...
uint8 ntp_server[] = {192, 168, 254, 30}; // microsoft
...
static void ICACHE_FLASH_ATTR ntp_udp_recv(void *arg, char *pdata, unsigned short len) {
	...
	os_sprintf(sDate, "%02d-%02d-%04d %02d:%02d:%02d\r\n", dt->tm_mday,dt->tm_mon+1,dt->tm_year+1900, dt->tm_hour+2, dt->tm_min, dt->tm_sec);
	uart0_tx_buffer(sDate, 25);
